...
const Adoption : React.FC<AdoptionInterface> = () => {
	return <div>
		<div className='header_pages'>
			...
			<div className='header_contain'>
				...
				<div className='header_routes'>
					...
					<span className='routes_current'><Link to={"/adopta"}>Adopta</Link></span>
				</div>
			</div>
		</div>
		<h2>"Darle un hogar a una mascota no cambiará el mundo, pero cambiará el mundo para esa mascota."</h2>
	</div>;
};
